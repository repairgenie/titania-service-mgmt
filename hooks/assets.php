<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'assets' table. 
	...
	*/
	...
	function assets_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function assets_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function assets_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['asset_client'], $data['asset_type'], $data['asset_mfr'], $data['asset_model'], $data['asset_serial'], $data['asset_IMEI']
	...
	*/
	...
	function assets_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function assets_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['asset_ID'], $data['asset_client'], $data['asset_type'], $data['asset_mfr'], $data['asset_model'], $data['asset_serial'], $data['asset_IMEI']
	...
	*/
	...
	function assets_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function assets_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function assets_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function assets_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function assets_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function assets_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function assets_batch_actions(&$args) {
