<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'technotes' table. 
	...
	*/
	...
	function technotes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function technotes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function technotes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['technote_tech'], $data['technote_note']
	...
	*/
	...
	function technotes_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['technote_tech'], $data['technote_note'], $data['technote_author'], $data['technote_timestamp'], $data['technote_editor'], $data['technote_editorts']
	...
	*/
	...
	function technotes_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['technote_ID'], $data['technote_tech'], $data['technote_note']
	...
	*/
	...
	function technotes_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['technote_ID'], $data['technote_tech'], $data['technote_note'], $data['technote_author'], $data['technote_timestamp'], $data['technote_editor'], $data['technote_editorts']
	...
	*/
	...
	function technotes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function technotes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function technotes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function technotes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function technotes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function technotes_batch_actions(&$args) {
