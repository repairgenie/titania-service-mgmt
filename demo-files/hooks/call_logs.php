<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'call_logs' table. 
	...
	*/
	...
	function call_logs_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function call_logs_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function call_logs_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['call_client'], $data['call_workorder'], $data['call_asset'], $data['call_invoice'], $data['call_logentry']
	...
	*/
	...
	function call_logs_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['call_datetime'], $data['call_loggedby'], $data['call_client'], $data['call_workorder'], $data['call_asset'], $data['call_invoice'], $data['call_logentry']
	...
	*/
	...
	function call_logs_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['call_ID'], $data['call_client'], $data['call_workorder'], $data['call_asset'], $data['call_invoice'], $data['call_logentry']
	...
	*/
	...
	function call_logs_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['call_ID'], $data['call_datetime'], $data['call_loggedby'], $data['call_client'], $data['call_workorder'], $data['call_asset'], $data['call_invoice'], $data['call_logentry']
	...
	*/
	...
	function call_logs_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function call_logs_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function call_logs_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function call_logs_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function call_logs_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function call_logs_batch_actions(&$args) {
