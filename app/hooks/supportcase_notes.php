<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'supportcase_notes' table. 
	...
	*/
	...
	function supportcase_notes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_notes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function supportcase_notes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function supportcase_notes_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['sc_notedatetime'], $data['sc_noteauthor'], $data['sc_notecase'], $data['sc_notedetails']
	...
	*/
	...
	function supportcase_notes_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_notes_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['sc_noteID'], $data['sc_notedatetime'], $data['sc_noteauthor'], $data['sc_notecase'], $data['sc_notedetails']
	...
	*/
	...
	function supportcase_notes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_notes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_notes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_notes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function supportcase_notes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_notes_batch_actions(&$args) {
