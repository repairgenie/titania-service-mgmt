<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'asset_notes' table. 
	...
	*/
	...
	function asset_notes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function asset_notes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function asset_notes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['assetnote_asset'], $data['assetnote_note']
	...
	*/
	...
	function asset_notes_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['assetnote_asset'], $data['assetnote_note'], $data['assetnote_author'], $data['assetnote_timestamp'], $data['assetnote_editor'], $data['assetnote_editorts']
	...
	*/
	...
	function asset_notes_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['assetnote_ID'], $data['assetnote_asset'], $data['assetnote_note']
	...
	*/
	...
	function asset_notes_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['assetnote_ID'], $data['assetnote_asset'], $data['assetnote_note'], $data['assetnote_author'], $data['assetnote_timestamp'], $data['assetnote_editor'], $data['assetnote_editorts']
	...
	*/
	...
	function asset_notes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function asset_notes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function asset_notes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function asset_notes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function asset_notes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function asset_notes_batch_actions(&$args) {
