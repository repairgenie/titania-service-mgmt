<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'workordernotes' table. 
	...
	*/
	...
	function workordernotes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function workordernotes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function workordernotes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['wonote_wo'], $data['wonote_note']
	...
	*/
	...
	function workordernotes_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['wonote_wo'], $data['wonote_note'], $data['wonote_author'], $data['wonote_timestamp'], $data['wonote_editor'], $data['wonote_editorts']
	...
	*/
	...
	function workordernotes_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function workordernotes_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['wonote_ID'], $data['wonote_wo'], $data['wonote_note'], $data['wonote_author'], $data['wonote_timestamp'], $data['wonote_editor'], $data['wonote_editorts']
	...
	*/
	...
	function workordernotes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function workordernotes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function workordernotes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function workordernotes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function workordernotes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function workordernotes_batch_actions(&$args) {
