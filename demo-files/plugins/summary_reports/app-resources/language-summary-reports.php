<?php
	...
	$ReportTranslation = [
		...
		'view table where label is' => 'View <TABLE> where <LABEL> is "<VALUE>"',
		'view table where label is and dates between' => 'View <TABLE> where <LABEL> is "<VALUE>" and <DATE_FIELD> between <DATE_FROM> and <DATE_TO>',
	];