<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'supportcase' table. 
	...
	*/
	...
	function supportcase_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function supportcase_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['case_status'], $data['case_client'], $data['case_call'], $data['case_openedby'], $data['case_external'], $data['case_subject'], $data['case_description']
	...
	*/
	...
	function supportcase_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['case_number'], $data['case_status'], $data['case_client'], $data['case_call'], $data['case_datetime'], $data['case_openedby'], $data['case_external'], $data['case_subject'], $data['case_description']
	...
	*/
	...
	function supportcase_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['case_ID'], $data['case_number'], $data['case_status'], $data['case_client'], $data['case_call'], $data['case_datetime'], $data['case_openedby'], $data['case_external'], $data['case_subject'], $data['case_description']
	...
	*/
	...
	function supportcase_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function supportcase_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function supportcase_batch_actions(&$args) {
