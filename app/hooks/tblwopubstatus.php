<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tblwopubstatus' table. 
	...
	*/
	...
	function tblwopubstatus_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tblwopubstatus_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tblwopubstatus_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['wopub_WO'], $data['wopub_status'], $data['wopub_Comments']
	...
	*/
	...
	function tblwopubstatus_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['wopub_WO'], $data['wopub_Updated'], $data['wopub_status'], $data['wopub_Comments']
	...
	*/
	...
	function tblwopubstatus_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tblwopubstatus_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['wopub_ID'], $data['wopub_WO'], $data['wopub_Updated'], $data['wopub_status'], $data['wopub_Comments']
	...
	*/
	...
	function tblwopubstatus_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tblwopubstatus_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tblwopubstatus_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tblwopubstatus_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tblwopubstatus_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tblwopubstatus_batch_actions(&$args) {
