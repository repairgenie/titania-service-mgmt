This folder contains language files for translating the common plugins UI.
...
When defining new language files:
 ...
 5. The new language would now be available for users to select in the plugin UI.
