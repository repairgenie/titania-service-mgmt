<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'workorders' table. 
	...
	*/
	...
	function workorders_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function workorders_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function workorders_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function workorders_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function workorders_batch_actions(&$args) {
