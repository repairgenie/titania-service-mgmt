<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ca' table. 
	...
	*/
	...
	function ca_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ca_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ca_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function ca_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ca_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function ca_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ca_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ca_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ca_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ca_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ca_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ca_batch_actions(&$args) {
