<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'techs' table. 
	...
	*/
	...
	function techs_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function techs_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function techs_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['techName'], $data['techPhone'], $data['techEmail'], $data['techPosition']
	...
	*/
	...
	function techs_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function techs_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['techID'], $data['techName'], $data['techPhone'], $data['techEmail'], $data['techPosition']
	...
	*/
	...
	function techs_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function techs_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function techs_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function techs_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function techs_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function techs_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function techs_batch_actions(&$args) {
